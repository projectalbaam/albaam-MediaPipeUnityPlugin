...
REM python build.py build --bazel_build_opts "--experimental_scale_timeous=10.0 --http_timeout_scaling=10.0" --android arm64 --android_ndk_api_level 21 --linkopt=-s -vv